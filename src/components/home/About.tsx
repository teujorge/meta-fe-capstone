export function About() {
  return (
    <div className="limit-width flex flex-row gap-4 p-4">
      <div className="w-1/2">
        <h2>Little Lemon</h2>
      ...
      <div className="relative w-1/2 p-8">
        <img
          ...
          alt="owner 1"
          className="object-cover w-1/2 h-72 absolute top-0 right-4 rounded-lg shadow-lg"
        />

        <img
          src="https://images.unsplash.com/photo-1542282081-9e0a16bb7366"
          alt="owner 2"
          className="object-cover w-1/2 h-72 absolute bottom-0 left-4 rounded-lg shadow-lg"
        />
      </div>
    </div>
  );
